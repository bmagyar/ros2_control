...
namespace
{
static constexpr const auto kTransmissionTag = "transmission";
static constexpr const auto kJointTag = "joint";
static constexpr const auto kHardwareInterfaceTag = "hardwareInterface";
}  // namespace

namespace transmission_interface
{
std::vector<TransmissionInfo> parseTransmissionsFromURDF(const std::string & urdf)
{
  if (urdf.empty()) {
